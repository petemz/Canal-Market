        ...
        <div className="home bg-blue-400 h-full flex">
            ...
            <Link to='/retail'>
                <div 
                    ...
                    className={`bg-red-500 ${currentPage === 'retail' ? 'w-[calc(100vw-180px)]' : 'w-[60px]'}  ${currentPage === null ? 'h-0' : 'h-full'} text-xl flex justify-center items-center flex-shrink-0 relative`}
                >
