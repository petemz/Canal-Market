    ...
    return (
        <>  
            ...
            <div className="py-16 xs:py-10 pb-8 tracking-widest [word-spacing:4px]">
                        ...
                        <div className='h-48 sm:h-36 loop-des flex flex-col tracking-widest justify-center items-center'>
                            <div className='h-7 w-7 mb-4'>
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" x="0" y="0" viewBox="0 0 512.005 512.005" style={{ enableBackground: 'new 0 0 512 512'}} xmlSpace="preserve">
                                    <g>
                                        <path d="M373.406 0H138.594C62.172 0 0 62.172 0 138.594V373.41C0 449.828 62.172 512 138.594 512H373.41C449.828 512 512 449.828 512 373.41V138.594C512 62.172 449.828 0 373.406 0zm108.578 373.41c0 59.867-48.707 108.574-108.578 108.574H138.594c-59.871 0-108.578-48.707-108.578-108.574V138.594c0-59.871 48.707-108.578 108.578-108.578H373.41c59.867 0 108.574 48.707 108.574 108.578zm0 0" fill="#000000" data-original="#000000"></path>
                ...
                <div className='p-7 px-16 sm:px-8 flex sm:flex-col justify-between items-center loop-des'>
                    ...
                    <div className='relative w-full max-w-[700px]'>
                        ...
                        <input className='h-14 px-8 w-full tracking-widest bg-inherit placeholder:text-black placeholder:font-semibold border border-black' placeholder='Email' type="text" />
                    </div>
                </div>
            </div>
            ...
            <footer className='flex text-sm sm:text-xs font-semibold justify-between mb-16'>
                ...
                <p>Inspired by <a href="https://zero.nyc/" target="blank"><em className='text-red-500'>ZERO</em></a></p>
            </footer>
        </>
    )
}
